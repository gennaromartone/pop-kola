...
export const ArrowForwardIcon: FC<DefaultIconProps> = (props) =>  {
    ...
    >
        ...
        <g id="Icons" transform="translate(-219.000000, -255.000000)" stroke="#FFFFFF" strokeWidth="4">
            <g id="forward" transform="translate(221.500000, 257.500000)">
